...
Read the skill file at `~/.copilot/instructions/sdd-archive/SKILL.md` and follow it exactly.
Also read shared conventions at `~/.copilot/instructions/_shared/sdd-phase-common.md`.
